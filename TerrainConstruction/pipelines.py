...
class TerrainconstructionPipeline(object):
    def __init__(self):
        self.files = {}
    ...
    def spider_opened(self, spider):
        ...
        #self.exporter.fields_to_export = ["MINI_SITE_URL","MINI_SITE_ID","AGENCE_NOM","AGENCE_ADRESSE","AGENCE_CP","AGENCE_VILLE","AGENCE_DEPARTEMENT","WEBSITE"] <= annuaire.py
